...
合计: **590,907** 行代码（覆盖前 5 种语言、共 **1359** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Julia | 409,445 | 43,894 | 45,105 | 940 |
| C | 81,079 | 10,802 | 7,490 | 118 |
| Cpp | 42,531 | 5,570 | 3,468 | 51 |
| CHeader | 18,616 | 4,294 | 2,696 | 90 |
| Toml | 7,409 | 48 | 882 | 160 |
...
- **Star**: 49,087 · **Fork**: 5,974 · **开放 issue**: 26,185 · **贡献者**: 1,618

## 累计统计

- **发布数**: 205 · **已合并 PR**: 27959 · **开放 PR**: 1023 · **已关闭 issue**: 22568 · **开放 issue**: 3617 · **提交数**: 62899
...
在 [repology.org](https://repology.org/project/julia) 上共有 **190** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**95** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T20:19:31Z._
